...
function raiseNumberToDegreeResult() {
    alert(`Результат : ${raiseNumberToDegree(prompt("Введіть число", 5),(prompt("Введіть степінь", 5)))}`);
}
function formatNameResult() {
    alert(`Результат : ${formatName(prompt("Введіть ім'я", "пАвлО"))}`);
}
...
function countLettersInWordResult() {
    alert(`Символів у слові : ${countLettersInWord(prompt("Введіть символ для підрахунку", "а").toLowerCase(),(prompt("Введіть слово", "Абабакаламага").toLowerCase()))}`);
}
...
function deleteLettersResult() {
    alert(`Результат : ${deleteLetters(prompt("Введіть рядок символів", "Абабакаламага").toLowerCase(),(prompt("Введіть символ який потрібно прибрати", "а").toLowerCase()))}`);
}
function isPalyndromResult() {
    alert(`Слово паліндром ? - : ${isPalyndromCheck((prompt("Введіть слово", "Пилип").toLowerCase()).replace(/\s+/g,''))}`);
}
function deleteDuplicateLetterResult() {
    alert(`Результат : ${deleteDuplicateLetter(prompt("Введіть стрічку", "Авада кедавра").toLowerCase())}`);
}